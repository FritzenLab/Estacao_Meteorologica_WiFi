/*
 *  ESP8266 + bmp180 + DHT11 + thinkspeak.com
 *
 *
 */
...
void setup() {
  ...
  String tt=String(temp/10)+"."+tdec; // 'tt' is the BMP180 temperature 
  ...
  client.print(String("GET ") + "/update?key="+apikey+"&field1="+tt+"&field2="+t+"&field3="+pp+"&field4="+h+"&field5="+valorLDR+"&field6="+counter+"   HTTP/1.1\r\n" +
               "Host: " + host + "\r\n" + 
               "Connection: close\r\n\r\n");
  delay(10);
